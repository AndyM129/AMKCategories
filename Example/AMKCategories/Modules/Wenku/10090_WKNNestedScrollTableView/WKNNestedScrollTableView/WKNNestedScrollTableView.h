...
/// 已缓存的 Cell，用于保存「如含有 WKWebView 等子视图的，在刷新时 无需重新加载」的 Cell
@property (nonatomic, strong, readonly, nullable) NSMutableDictionary<WKNNestedScrollTableViewCacheKey *, WKNNestedScrollTableViewCachedCell *> *cachedCells;

/// 已重写父类方法，以添加对 `WKNNestedScrollTableViewCachedCellProtocol` 协议的支持
///
