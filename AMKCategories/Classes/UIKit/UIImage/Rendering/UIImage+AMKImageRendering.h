...
- (UIImage *_Nullable)amk_imageWithAlpha:(CGFloat)alpha;

#pragma mark - Tint Color

/// 以当前图像渲染成指定颜色，并返回新图像
- (UIImage *_Nullable)amk_imageWithTintColor:(UIColor *_Nullable)tintColor;

/// 以当前图像 以指定混合模式，颜色进行处理，并返回新图像
- (UIImage *_Nullable)amk_imageWithTintColor:(UIColor *_Nullable)tintColor blendMode:(CGBlendMode)blendMode;
